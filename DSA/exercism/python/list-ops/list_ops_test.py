...
class ListOpsTestAppend(unittest.TestCase):
...
class ListOpsTestConcat(unittest.TestCase):
...
class ListOpsTestFilter(unittest.TestCase):
...
class ListOpsTestLength(unittest.TestCase):
...
class ListOpsTestListOptMap(unittest.TestCase):
...
class ListOpsTestFoldl(unittest.TestCase):
...
class ListOpsTestFoldr(unittest.TestCase):
...
class ListOpsTestReverse(unittest.TestCase):
...
class ListOpsTestReverseFlattenedReverse(unittest.TestCase):
