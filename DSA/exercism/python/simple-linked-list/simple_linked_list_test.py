...
class TestSimpleLinkedListPush(unittest.TestCase):
...
class TestSimpleLinkedListReversed(unittest.TestCase):
...
class TestSimpleLinkedListRaises(unittest.TestCase):
