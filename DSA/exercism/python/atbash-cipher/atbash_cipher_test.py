...
from atbash_cipher import conv, decode, encode

# Tests adapted from `problem-specifications//canonical-data.json`


class AtbashCipherEncodeTest(unittest.TestCase):
...
class TestChmap(unittest.TestCase):
    def test_z(self):
        self.assertEqual(conv("z"), "a")

    def test_m(self):
        self.assertEqual(conv("m"), "n")

    def test_n(self):
        self.assertEqual(conv("n"), "m")

    def test_a(self):
        self.assertEqual(conv("a"), "z")
