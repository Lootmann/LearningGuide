...
class TestVariableLengthQuantityEncode(unittest.TestCase):
    def test_zero(self):
...
class TestVariableLengthQuantityDecode(unittest.TestCase):
...
class TestVariableLengthQuantityRaises(unittest.TestCase):
